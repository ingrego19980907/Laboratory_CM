...
print('___Завдання №6 Перетворюватиме двовимірний масив з пункту 2 у двовимірний масив, в якому розміри обох вимірів співпадають. Розглянути додавання стовпчиків до кількості рядочків та урізання кількості стовпчиків до кількості рядочків.___ \n')
...
print("___10 Перетворюватиме DataFrame з пункту 8 у двовимірний масив. За правилами добутку матриць множитиме цей масив на масив з пункту 6, з власних векторів якого було побудовано DataFrame у пункті 8. ___ \n")
